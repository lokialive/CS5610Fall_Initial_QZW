...
import * as service from './savedItem-service.js'

export const findSavedItemsThunk = createAsyncThunk(
  'savedItems/findSavedItems',
  async () => {
...
export const createSavedItemThunk = createAsyncThunk(
  'savedItems/createSavedItem',
  async (savedItem) => await service.createSavedItem(savedItem),
)

export const updateSavedItemThunk = createAsyncThunk(
  'savedItems/updateSavedItem',
  async (savedItem) => await service.updateSavedItem(savedItem),
)
